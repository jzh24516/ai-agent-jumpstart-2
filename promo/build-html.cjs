...
const IMG = {
  ...
  blueprint: {
    ...
    vi: b64('agent-platform-blueprint-vi.webp') || b64('agent-platform-blueprint-en.webp'),
  },
  ...
  jumpstart: {
    ...
    vi: b64('jumpstart-vietnamese.png') || b64('jumpstart-english.png'),
  },
...
<section class="slide cover" data-title="Cover">
  ...
  <div class="cover-wrap">
    ...
    <h1 class="hero">AI Agent Workshop<br><span class="grad">by Microsoft Agent GBB</span></h1>
    ...
    <div class="cover-meta">
      <span>Microsoft Global Solution Advisor - Agent GBB Asia Team</span><span class="sep">&middot;</span><span>July 16, 2026</span>
    </div>
    <div class="pillrow">
      <span class="pill" data-i18n="c.p1">6 guided labs</span>
      <span class="pill" data-i18n="c.p2">29 steps</span>
      <span class="pill" data-i18n="c.p3">9 languages</span>
...
<section class="slide one-liner-slide" data-title="What it is">
  ...
  <div class="two">
    ...
    <div class="col stats">
      ...
      <div class="stat"><div class="se">🌍</div><div class="num">9</div><div class="lbl" data-i18n="s2.l3">languages</div></div>
  ...
  <div class="maker-cover-grid">
    <div class="maker-cover-copy">
      ...
      <div class="maker-capabilities">
        <div class="maker-capability"><span class="maker-capability-icon">文</span><div><b data-i18n="slc.t1">Choose your language</b><span data-i18n="slc.d1">Nine localized experiences</span></div></div>
...
<section class="slide" data-title="Multilingual">
  ...
  <div class="two shots-row">
    <div class="col">
      <p class="big" data-i18n="s4.big">One click switches the <b>entire lab experience</b> — the same page, instructions, sidebar, and UI — between <b>English, 简体中文, 廣東話 (香港), 繁體中文 (台灣), 日本語, 한국어, ไทย, हिन्दी, and Tiếng Việt</b>.</p>
      <ul class="ticks">
  ...
  <div class="vp-grid">
    ...
    <div class="vp-copy">
      ...
      <div class="vflow">
        ...
        <div class="vstep"><span class="vi">🌍</span><div class="vt"><b data-i18n="s10.t4">Multilingual Ready</b><span data-i18n="s10.d4">Nine languages, one shareable link.</span></div></div>
...
<section class="slide closing" data-title="Bring it to your workshop">
  ...
  <div class="close-grid">
    <div class="close-wrap">
      ...
      <h2 class="hero sm" data-i18n="s9.h">Bring AI Agent Workshop to your<br><span class="grad">next customer workshop</span></h2>
      ...
      <a class="urlbar" href="https://aka.ms/ai-agent-workshop-v2" target="_blank" rel="noreferrer" style="text-decoration:none">
        <span class="urllbl" data-i18n="s9.live">Live workshop</span>
        <code>aka.ms/ai-agent-workshop-v2</code>
      </a>
      <div class="contacts">
      ...
      <div class="madeby">Microsoft Global Solution Advisor - Agent GBB Asia Team</div>
      <div class="thanks">
        <span class="thanks-label" data-i18n="s9.thanks">With thanks to the contribution of AI Agent Workshop v-Team</span>
        <div class="thanks-names"><span>Nalin Shukla</span><span>Scott Berry</span><span>Steve Ng</span><span>Anand Ponnusamy</span></div>
      </div>
    </div>
...
<title>AI Agent Workshop by Microsoft Agent GBB — Highlights</title>
<style>
  :root{
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .one-liner-slide h2{font-size:3.15rem;white-space:nowrap}
  ...
  .cover .hero .grad{display:inline-block;font-size:.76em;line-height:1.12;white-space:nowrap}
  ...
  .closing .hero.sm{font-size:3.35rem}
...
<script>
  ...
  const blueprintAlt={
    ...
    vi:'Sơ đồ nền tảng Agent của Copilot Studio: sáu lab được ánh xạ từ trường hợp sử dụng đến chế độ Agent, kiến trúc, công cụ và giá trị kinh doanh',
  };
  const T={
    zh:{
      'c.lede':'一个动手、自主、多语言的实验体验，全面构建 Microsoft Copilot Studio 中的各类自定义 Agent。',
      'c.p1':'6 个引导实验','c.p2':'29 个步骤','c.p3':'9 种语言','c.p4':'1 个可分享链接',
      ...
      'slc.k':'JumpStart Learner','slc.h':'<span class="grad">学习者体验</span>','slc.lede':'打开一个链接，选择语言，按照引导步骤以自己的节奏构建真实 Agent；复制现成提示词、查看截图，并在进度庆祝中持续前进。','slc.t1':'选择语言','slc.d1':'9 种本地化体验','slc.t2':'跟随指南','slc.d2':'6 个实验与 29 个结构化步骤','slc.t3':'复制并构建','slc.d3':'提示词、提示框与截图','slc.t4':'庆祝进度','slc.d4':'完成跟踪与烟花效果','slc.signal':'一条引导旅程 · 动手构建真实 Agent',
      ...
      's8.b1':'打开链接','s8.s1':'一个 URL，任意现代浏览器。开始无需安装、无需登录。','s8.b2':'选择语言','s8.s2':'在封面切换 EN / 简体中文 / 廣東話 / 繁體中文 / 日本語 / 한국어 / ไทย / हिन्दी / Tiếng Việt。','s8.b3':'进入并构建','s8.s3':'逐个实验推进，复制提示词，跟踪进度，尽情庆祝。','s8.url':'在线研讨会','s8.lede':'一个链接。任意语言。几分钟内构建真实 Agent — 无需安装、无需等待。','s8.c1':'上手超简单','s8.c2':'自助服务','s8.c3':'自定进度','s8.c4':'复制即构建','s8.c5':'多语言就绪',
      's9.badge':'随时可以开始','s9.live':'在线研讨会','s9.thanks':'特别感谢 AI Agent Workshop v-Team 团队的贡献','s9.h':'把 AI Agent Workshop 带到你的<br><span class="grad">下一场客户研讨会</span>','s9.lede':'无论是内部赋能还是外部客户活动 &mdash; 联合品牌化、分享链接，让参与者亲手构建真实 Agent。','s10.k':'⚡ JumpStart V2','s10.h':'从<span class="grad">实验到影响</span>','s10.t1':'快速起步','s10.d1':'打开一个链接即可开始 — 无需安装、无需配置。','s10.t2':'自助 & 自定进度','s10.d2':'参与者自主推进，你只需引导。','s10.t3':'复制即构建','s10.d3':'可复制的提示词，将每一步变成真正可用的 Agent。','s10.t4':'多语言就绪','s10.d4':'九种语言，一个可分享链接。','s10.t5':'从实验到影响','s10.d5':'快速交付带来真实业务价值的 Agent。',
      'ui.hint':'← → 切换 · F 全屏',
    },
    ja:{
      'c.lede':'Microsoft Copilot Studio でカスタム Agent の全領域を構築する、ハンズオン・自習型・多言語のラボ体験。',
      'c.p1':'6 つのガイド ラボ','c.p2':'29 ステップ','c.p3':'9 言語','c.p4':'共有リンク 1 つ',
      ...
      's8.b1':'リンクを開く','s8.s1':'URL 1 つ、モダンなブラウザで。インストールもサインインも不要。','s8.b2':'言語を選ぶ','s8.s2':'表紙で EN / 简体中文 / 廣東話 / 繁體中文 / 日本語 / 한국어 / ไทย / हिन्दी / Tiếng Việt に切り替え。','s8.b3':'入って構築','s8.s3':'ラボごとに進め、プロンプトをコピー、進捗を記録、お祝い。','s8.url':'ライブ ワークショップ','s8.lede':'リンク 1 つ。どの言語でも。数分で本物の Agent — インストールも待ち時間もなし。','s8.c1':'起動は超かんたん','s8.c2':'セルフサービス','s8.c3':'自分のペースで','s8.c4':'コピーして構築','s8.c5':'多言語対応',
      's9.badge':'準備はいつでも','s9.live':'ライブ ワークショップ','s9.thanks':'AI Agent Workshop v-Team の皆さんの貢献に感謝します','s9.h':'AI Agent Workshop を<br><span class="grad">次の顧客ワークショップ</span>へ','s9.lede':'社内イネーブルメントでも外部の顧客イベントでも &mdash; 共同ブランド化してリンクを共有し、参加者に実際の Agent を手を動かして構築してもらいましょう。','s10.k':'⚡ JumpStart V2','s10.h':'<span class="grad">ラボからインパクト</span>へ','s10.t1':'ファストスタート','s10.d1':'リンク 1 つで開始 — インストールも設定も不要。','s10.t2':'セルフサービス & 自分のペース','s10.d2':'参加者が自ら進め、あなたはファシリテート。','s10.t3':'コピーして構築','s10.d3':'コピーできるプロンプトで、各ステップを本物の Agent に。','s10.t4':'多言語対応','s10.d4':'9 言語、共有リンク 1 つ。','s10.t5':'ラボからインパクトへ','s10.d5':'実際のビジネス価値を生む Agent を、素早く届ける。',
      'ui.hint':'← → で移動 · F 全画面',
    },
    ko:{
      'c.lede':'Microsoft Copilot Studio에서 다양한 맞춤형 Agent를 구축하는 실습형, 자기 주도, 다국어 랩 경험.',
      'c.p1':'가이드 랩 6개','c.p2':'29단계','c.p3':'9개 언어','c.p4':'공유 링크 1개',
      ...
      's8.b1':'링크 열기','s8.s1':'URL 하나, 최신 브라우저면 됩니다. 설치·로그인 없이 시작.','s8.b2':'언어 선택','s8.s2':'표지에서 EN / 简体中文 / 廣東話 / 繁體中文 / 日本語 / 한국어 / ไทย / हिन्दी / Tiếng Việt로 전환.','s8.b3':'입장 후 구축','s8.s3':'랩을 차례로 진행하고 프롬프트 복사, 진행 추적, 축하까지.','s8.url':'라이브 워크숍','s8.lede':'링크 하나. 어떤 언어든. 몇 분 만에 진짜 Agent — 설치도 대기도 없이.','s8.c1':'시작이 매우 쉬움','s8.c2':'셀프 서비스','s8.c3':'자기 주도 학습','s8.c4':'복사하고 빌드','s8.c5':'다국어 지원',
      's9.badge':'언제든 준비 완료','s9.live':'라이브 워크숍','s9.thanks':'AI Agent Workshop v-Team의 기여에 감사드립니다','s9.h':'AI Agent Workshop을<br><span class="grad">다음 고객 워크숍</span>으로','s9.lede':'내부 역량 강화든 외부 고객 행사든 &mdash; 공동 브랜딩하고 링크를 공유해 참가자가 실제 Agent를 직접 만들게 하세요.','s10.k':'⚡ JumpStart V2','s10.h':'<span class="grad">랩에서 임팩트</span>로','s10.t1':'빠른 시작','s10.d1':'링크 하나로 시작 — 설치도 설정도 없이.','s10.t2':'셀프 서비스 & 자기 주도','s10.d2':'참가자가 스스로 진행하고 당신은 퍼실리테이션.','s10.t3':'복사하고 빌드','s10.d3':'복사 가능한 프롬프트로 각 단계를 진짜 작동하는 Agent로.','s10.t4':'다국어 지원','s10.d4':'아홉 개 언어, 하나의 공유 링크.','s10.t5':'랩에서 임팩트로','s10.d5':'실제 비즈니스 가치를 주는 Agent를 빠르게 제공.',
      'ui.hint':'← → 이동 · F 전체화면',
    },
    th:{
      ...
      'c.p1':'6 แล็บพร้อมคำแนะนำ','c.p2':'29 ขั้นตอน','c.p3':'9 ภาษา','c.p4':'1 ลิงก์สำหรับแชร์',
      ...
      'slc.k':'JumpStart Learner','slc.h':'<span class="grad">ประสบการณ์ผู้เรียน</span>','slc.lede':'เปิดลิงก์เดียว เลือกภาษา และสร้าง Agent จริงตามจังหวะของคุณด้วยขั้นตอนแนะนำ พรอมป์พร้อมคัดลอก ภาพหน้าจอ และการเฉลิมฉลองความคืบหน้า','slc.t1':'เลือกภาษา','slc.d1':'ประสบการณ์แปล 9 ภาษา','slc.t2':'ทำตามคำแนะนำ','slc.d2':'6 แล็บและ 29 ขั้นตอนที่เป็นระบบ','slc.t3':'คัดลอกแล้วสร้าง','slc.d3':'พรอมป์ คำแนะนำ และภาพหน้าจอ','slc.t4':'ฉลองความคืบหน้า','slc.d4':'ติดตามการทำเสร็จและพลุ','slc.signal':'เส้นทางแนะนำเดียว · ลงมือสร้าง Agent จริง',
      ...
      's8.b1':'เปิดลิงก์','s8.s1':'URL เดียว เบราว์เซอร์สมัยใหม่ใดก็ได้ เริ่มได้โดยไม่ต้องติดตั้งหรือลงชื่อเข้าใช้','s8.b2':'เลือกภาษา','s8.s2':'สลับเป็น EN / 简体中文 / 廣東話 / 繁體中文 / 日本語 / 한국어 / ไทย / हिन्दी / Tiếng Việt ที่หน้าปก','s8.b3':'เข้าสู่ระบบ &amp; สร้าง','s8.s3':'ทำทีละแล็บ คัดลอกพรอมป์ ติดตามความคืบหน้า และเฉลิมฉลอง','s8.url':'เวิร์กช็อปสด','s8.lede':'ลิงก์เดียว ทุกภาษา สร้าง Agent จริงในไม่กี่นาที — ไม่ต้องติดตั้ง ไม่ต้องรอ','s8.c1':'เริ่มง่ายสุด ๆ','s8.c2':'บริการตนเอง','s8.c3':'เรียนตามจังหวะตัวเอง','s8.c4':'คัดลอกแล้วสร้าง','s8.c5':'พร้อมหลายภาษา',
      's9.badge':'พร้อมเมื่อคุณพร้อม','s9.live':'เวิร์กช็อปสด','s9.thanks':'ขอขอบคุณการมีส่วนร่วมจากทีม AI Agent Workshop v-Team','s9.h':'นำ AI Agent Workshop ไปสู่<br><span class="grad">เวิร์กช็อปลูกค้าครั้งถัดไป</span>','s9.lede':'ไม่ว่าจะเป็นการเสริมศักยภาพภายในหรืออีเวนต์ลูกค้าภายนอก &mdash; ร่วมแบรนด์ แชร์ลิงก์ และให้ผู้เข้าร่วมสร้าง Agent จริงด้วยตนเอง','s10.k':'⚡ JumpStart V2','s10.h':'จาก<span class="grad">แล็บสู่ผลลัพธ์</span>','s10.t1':'เริ่มเร็ว','s10.d1':'เปิดลิงก์เดียวก็เริ่มได้ — ไม่ต้องติดตั้ง ไม่ต้องตั้งค่า','s10.t2':'บริการตนเอง & ตามจังหวะ','s10.d2':'ผู้เข้าร่วมขับเคลื่อนเอง ส่วนคุณเป็นผู้อำนวยความสะดวก','s10.t3':'คัดลอกแล้วสร้าง','s10.d3':'พรอมป์ที่คัดลอกได้ เปลี่ยนแต่ละขั้นตอนเป็น Agent ที่ใช้งานได้จริง','s10.t4':'พร้อมหลายภาษา','s10.d4':'เก้าภาษา ลิงก์แชร์เดียว','s10.t5':'จากแล็บสู่ผลลัพธ์','s10.d5':'ส่งมอบ Agent ที่สร้างคุณค่าทางธุรกิจจริง — อย่างรวดเร็ว',
    ...
    hi:{
      ...
      'c.p1':'6 निर्देशित लैब','c.p2':'29 चरण','c.p3':'9 भाषाएँ','c.p4':'1 साझा करने योग्य लिंक',
      ...
      's8.b1':'लिंक खोलें','s8.s1':'एक URL, कोई भी आधुनिक ब्राउज़र। शुरू करने के लिए न इंस्टॉल, न साइन-इन।','s8.b2':'एक भाषा चुनें','s8.s2':'कवर पर EN / 简体中文 / 廣東話 / 繁體中文 / 日本語 / 한국어 / ไทย / हिन्दी / Tiếng Việt पर स्विच करें।','s8.b3':'प्रवेश करें &amp; बनाएँ','s8.s3':'लैब दर लैब काम करें, प्रॉम्प्ट कॉपी करें, प्रगति ट्रैक करें, जश्न मनाएँ।','s8.url':'लाइव वर्कशॉप','s8.lede':'एक लिंक। कोई भी भाषा। मिनटों में असली Agent — न इंस्टॉल, न इंतज़ार।','s8.c1':'शुरू करना बेहद आसान','s8.c2':'सेल्फ-सर्व','s8.c3':'अपनी गति से','s8.c4':'कॉपी करें और बनाएँ','s8.c5':'बहुभाषी तैयार',
      's9.badge':'जब आप तैयार हों','s9.live':'लाइव वर्कशॉप','s9.thanks':'AI Agent Workshop v-Team टीम के योगदान के लिए हार्दिक धन्यवाद','s9.h':'AI Agent Workshop को अपनी<br><span class="grad">अगली ग्राहक वर्कशॉप</span> में लाएँ','s9.lede':'आंतरिक सक्षमता हो या बाहरी ग्राहक कार्यक्रम &mdash; इसे को-ब्रांड करें, लिंक साझा करें, और प्रतिभागियों को असली Agent व्यावहारिक रूप से बनाने दें।','s10.k':'⚡ JumpStart V2','s10.h':'<span class="grad">लैब से प्रभाव</span> तक','s10.t1':'फ़ास्ट स्टार्ट','s10.d1':'एक लिंक खोलें और शुरू करें — न इंस्टॉल, न सेटअप।','s10.t2':'सेल्फ-सर्व और अपनी गति','s10.d2':'प्रतिभागी खुद आगे बढ़ते हैं, आप सहायक बनते हैं।','s10.t3':'कॉपी करें और बनाएँ','s10.d3':'कॉपी-तैयार प्रॉम्प्ट हर चरण को असली, काम करते Agent में बदलते हैं।','s10.t4':'बहुभाषी तैयार','s10.d4':'नौ भाषाएँ, एक साझा लिंक।','s10.t5':'लैब से प्रभाव तक','s10.d5':'असली व्यावसायिक मूल्य देने वाले Agent तेज़ी से पहुँचाएँ।',
      'ui.hint':'← → नेविगेट · F पूर्ण स्क्रीन',
    },
    vi:{
      'c.lede':'Trải nghiệm lab đa ngôn ngữ, thực hành và tự học để xây dựng đầy đủ các loại Agent tùy chỉnh trong Microsoft Copilot Studio.',
      'c.p1':'6 lab có hướng dẫn','c.p2':'29 bước','c.p3':'9 ngôn ngữ','c.p4':'1 liên kết có thể chia sẻ',
      's2.k':'🎬 Tóm tắt trong một câu','s2.h':'Workshop tự vận hành &mdash; <span class="grad">người học chỉ cần nhấn phát</span> ▶️',
      ...
      's5.k':'Tính năng nổi bật 02','s5.h':'UX học qua thực hành <span class="grad">thực sự thú vị</span>',
      's5.b1':'Các bước giàu định dạng Markdown','s5.s1':'Tiêu đề, bảng, chú thích &amp; phần nhấn mạnh đều được hiển thị đẹp mắt.','s5.b2':'Prompt sẵn sàng để sao chép','s5.s2':'Mỗi chỉ dẫn được sao chép vào clipboard chỉ với một cú nhấp.','s5.b3':'Theo dõi tiến độ','s5.s3':'Theo dõi mức hoàn thành từng bước trong toàn bộ 29 bước và lưu cục bộ.','s5.b4':'Pháo hoa khi hoàn thành','s5.s4':'Mỗi bước hoàn tất đều được chúc mừng bằng hiệu ứng pháo hoa.','s5.b5':'Glass UI, giao diện sáng &amp; tối','s5.s5':'Thiết kế kính mờ hiện đại, đồng bộ theo chủ đề ở mọi nơi.',
      's6.k':'Tính năng nổi bật 03','s6.h':'Đồng thương hiệu cho một <span class="grad">workshop riêng</span> chỉ trong vài giây',
      's6.b1':'Microsoft &times; Khách hàng','s6.s1':'Đặt tên hoặc logo khách hàng và đăng ký email người tham gia để xác thực quyền truy cập lab &mdash; trang bìa được đồng thương hiệu ngay lập tức.','s6.b2':'Lưu &amp; tái sử dụng','s6.s2':'Lịch sử workshop: lưu, truy xuất và tìm nhanh các cấu hình trước đây.','s6.b3':'Logo từ URL hoặc tải lên','s6.s3':'Hoàn toàn tự chứa &mdash; không cần dịch vụ lưu trữ hình ảnh bên ngoài.','s6.b4':'Bảo vệ bằng mật khẩu','s6.s4':'Chỉ người điều phối mới có thể thay đổi thương hiệu &mdash; dùng cùng cơ chế bảo vệ như chế độ chỉnh sửa.','s6.b5':'Nhập danh sách email người tham gia','s6.s5':'Dán hàng loạt hoặc tải lên danh sách người tham gia đã đăng ký của khách hàng &mdash; chỉ email khớp mới có thể vào và xác thực từng lab.',
      's7.k':'Tính năng nổi bật 04','s7.h':'Xuất bản một lần &mdash; <span class="grad">mọi người đều thấy</span>',
      's7.b1':'Cấu hình cục bộ','s7.s1':'Thiết lập thương hiệu &amp; chỉnh sửa nội dung lab trong giao diện Maker.','s7.b2':'Áp dụng &amp; commit','s7.s2':'Thương hiệu &amp; nội dung được phát hành dưới dạng <code>branding.json</code> + <code>labs.json</code>.','s7.b3':'Tự động triển khai','s7.s3':'GitHub Actions build &amp; xuất bản lên GitHub Pages sau mỗi lần push.','s7.b4':'Mọi người đều thấy','s7.s4':'Người tham gia mở URL trực tiếp &mdash; cùng nội dung, cùng thương hiệu.','s7.note':'Không cần thiết lập riêng cho từng người dùng. Các tệp đã xuất bản là nguồn thông tin chuẩn duy nhất cho mọi khách truy cập.',
      'sp.k':'Hướng dẫn người tham gia','sp.h':'Từ email đã đăng ký đến <span class="grad">Lab 6</span>','sp.lede':'Truy cập an toàn, làm theo từng lab có hướng dẫn và biến chỉ dẫn sẵn sàng để sao chép thành trải nghiệm thực hành.',
      'sp.t1':'Mở workshop trực tiếp','sp.d1':'Mở <code>aka.ms/ai-agent-jumpstart-v2</code> và chọn ngôn ngữ bạn muốn trên trang chào mừng.','sp.t2':'Xác thực email đã đăng ký','sp.d2':'Dùng email do người tổ chức đăng ký. Việc đối chiếu không phân biệt chữ hoa chữ thường (ABC = abc); email không có trong danh sách sẽ không thể truy cập.','sp.t3':'Bắt đầu từ Lab 1','sp.d3':'Chọn “Vào workshop”. Mở Lab 1 từ menu lab bên trái (hoặc menu trên thiết bị di động), rồi xem kết quả, mục tiêu và điều kiện tiên quyết.','sp.t4':'Làm theo từng bước hướng dẫn','sp.d4':'Dùng Mục lục hoặc bộ chọn bước ở phía trên. Hoàn thành từng trang được đánh số theo thứ tự và làm theo ảnh chụp màn hình cùng chú thích.','sp.t5':'Sao chép, chuyển ứng dụng, thực hiện, quay lại','sp.d5':'Chọn Sao chép trên prompt, chuyển sang Copilot Studio hoặc ứng dụng được chỉ định, thực hiện hoạt động rồi quay lại hướng dẫn.','sp.t6':'Hoàn thành và tiếp tục đến Lab 6','sp.d6':'Đánh dấu Hoàn thành cho từng bước. Chọn Tiếp tục hoặc chọn lab tiếp theo trong menu; lặp lại đến Lab 6. Tiến độ được lưu trong trình duyệt này.','sp.noteLabel':'Lưu ý','sp.note':'Dùng cùng một trình duyệt và thiết bị để giữ tiến độ. Nếu email không được nhận diện, hãy liên hệ người tổ chức workshop.',
      'slc.k':'JumpStart Learner','slc.h':'<span class="grad">Trải nghiệm người học</span>','slc.lede':'Mở một liên kết, chọn ngôn ngữ và xây dựng Agent thực tế theo tiến độ riêng với các bước có hướng dẫn, prompt sẵn sàng để sao chép, ảnh chụp màn hình và những màn chúc mừng tiến độ.','slc.t1':'Chọn ngôn ngữ','slc.d1':'9 trải nghiệm được bản địa hóa','slc.t2':'Làm theo hướng dẫn','slc.d2':'6 lab &amp; 29 bước có cấu trúc','slc.t3':'Sao chép và xây dựng','slc.d3':'Prompt, chú thích &amp; ảnh chụp màn hình','slc.t4':'Chúc mừng tiến độ','slc.d4':'Theo dõi hoàn thành &amp; pháo hoa','slc.signal':'Một hành trình có hướng dẫn &middot; tự tay xây dựng Agent thực tế',
      'smc.k':'JumpStart Maker','smc.h':'<span class="grad">Trải nghiệm Maker</span>','smc.lede':'Điều chỉnh nội dung học tập, định hình chủ đề và thương hiệu workshop sẵn sàng cho khách hàng, kiểm soát quyền truy cập bằng danh sách email người tham gia rồi xuất bản trải nghiệm hoàn chỉnh.','smc.t1':'Tinh chỉnh nội dung','smc.d1':'Lab, bước, prompt &amp; ảnh chụp màn hình','smc.t2':'Xây dựng thương hiệu workshop','smc.d2':'Chủ đề, nhận diện khách hàng &amp; thông tin người tổ chức','smc.t3':'Kiểm soát người tham gia','smc.d3':'Danh sách email khách hàng đã phê duyệt','smc.t4':'Tự tin xuất bản','smc.d4':'Kiểm thử, commit &amp; triển khai','smc.signal':'Một quy trình Maker &middot; một workshop sẵn sàng đón người tham gia',
      'sm.k':'Hướng dẫn Maker','sm.h':'Cấu hình, xây dựng &amp; <span class="grad">xuất bản</span> workshop khách hàng','sm.lede':'Chuẩn bị chương trình cục bộ, xây dựng nội dung có hướng dẫn và phát hành cả thương hiệu lẫn lab qua GitHub Pages.',
      'sm.t1':'Chạy cục bộ và mở khóa','sm.d1':'Chạy <code>npm run dev</code>, mở <code>localhost:5173</code>, chọn biểu tượng bánh răng hoặc bút chì rồi nhập mật khẩu Maker.','sm.t2':'Tạo thương hiệu cho chương trình','sm.d2':'Đặt tên người tổ chức và khách hàng, URL logo hoặc tệp tải lên, người chuẩn bị/ngày và đầu mối liên hệ của người tổ chức. Lưu vào lịch sử để tái sử dụng.','sm.t3':'Đăng ký người tham gia','sm.d3':'Thêm từng email hoặc dán danh sách được phân tách bằng dấu phẩy, dấu cách, tab hay dòng mới. Kiểm tra các chip rồi chọn Áp dụng để ghi <code>branding.json</code>.','sm.t4':'Tinh chỉnh nội dung lab','sm.d4':'Mở chế độ Maker bằng biểu tượng bút chì. Thêm hoặc sắp xếp lại lab, bước, trang, văn bản bản địa hóa, prompt và ảnh chụp màn hình; chỉ xuất bản các lab đã sẵn sàng.','sm.t5':'Lưu, kiểm thử và xuất bản','sm.d5':'Chọn Lưu để ghi <code>labs.json</code>, kiểm thử cục bộ bằng từng ngôn ngữ, rồi chọn Xuất bản để commit và push thương hiệu cùng nội dung lab.','sm.t6':'Xác nhận GitHub Pages','sm.d6':'Chờ workflow Deploy của GitHub Actions, sau đó hard-refresh URL trực tiếp và xác minh thương hiệu, quyền truy cập email, ngôn ngữ cùng luồng lab.','sm.noteLabel':'Phương án thủ công','sm.note':'<code>git add public/content/branding.json public/content/labs.json</code> &rarr; commit &rarr; <code>git push origin main</code>',
      's8.k':'⚡ Khởi động nhanh','s8.h':'JumpStart v2 chính là <span class="grad">Khởi động nhanh</span>',
      's8.b1':'Mở liên kết','s8.s1':'Một URL, bất kỳ trình duyệt hiện đại nào. Bắt đầu mà không cần cài đặt hay đăng nhập.','s8.b2':'Chọn ngôn ngữ','s8.s2':'Chuyển đổi ngay trên trang bìa giữa EN / 简体中文 / 廣東話 / 繁體中文 / 日本語 / 한국어 / ไทย / हिन्दी / Tiếng Việt.','s8.b3':'Truy cập &amp; xây dựng','s8.s3':'Tiến hành lần lượt từng lab, sao chép prompt, theo dõi tiến độ và ăn mừng.','s8.url':'Workshop trực tiếp','s8.lede':'Một liên kết. Bất kỳ ngôn ngữ nào. Xây dựng Agent thực tế trong vài phút — không cài đặt, không chờ đợi.','s8.c1':'Bắt đầu cực kỳ đơn giản','s8.c2':'Tự phục vụ','s8.c3':'Theo tiến độ riêng','s8.c4':'Sao chép và xây dựng','s8.c5':'Sẵn sàng đa ngôn ngữ',
      's9.badge':'Sẵn sàng khi bạn sẵn sàng','s9.live':'Workshop trực tiếp','s9.thanks':'Trân trọng cảm ơn những đóng góp của AI Agent Workshop v-Team','s9.h':'Đưa AI Agent Workshop vào<br><span class="grad">workshop khách hàng tiếp theo</span> của bạn','s9.lede':'Dù là đào tạo nội bộ hay sự kiện khách hàng bên ngoài &mdash; hãy đồng thương hiệu, chia sẻ liên kết và để người tham gia tự tay xây dựng Agent thực tế.','s10.k':'⚡ JumpStart V2','s10.h':'Từ <span class="grad">Lab đến tác động</span>','s10.t1':'Khởi động nhanh','s10.d1':'Mở một liên kết và bắt đầu &mdash; không cài đặt, không thiết lập.','s10.t2':'Tự phục vụ &amp; theo tiến độ riêng','s10.d2':'Người tham gia tự dẫn dắt hành trình trong khi bạn điều phối.','s10.t3':'Sao chép &amp; xây dựng','s10.d3':'Prompt sẵn sàng để sao chép biến mỗi bước thành một Agent thực tế đang hoạt động.','s10.t4':'Sẵn sàng đa ngôn ngữ','s10.d4':'Chín ngôn ngữ, một liên kết có thể chia sẻ.','s10.t5':'Từ Lab đến tác động','s10.d5':'Nhanh chóng đưa vào sử dụng các Agent tạo ra giá trị kinh doanh thực tế.',
      'ui.hint':'← → để điều hướng · F toàn màn hình',
    },
  };
  ...
  function applyLang(lang){
    ...
    const activeLangBtn=langBtns.find(b=>b.dataset.lang===lang);
    if(activeLangBtn&&langbar.scrollWidth>langbar.clientWidth){
      langbar.scrollLeft=Math.max(0,activeLangBtn.offsetLeft-(langbar.clientWidth-activeLangBtn.offsetWidth)/2);
    }
