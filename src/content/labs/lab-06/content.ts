  ...
  steps: [
    {
      ...
      pages: [{
        ...
        markdown: { en: createStep, zh: '', ja: '', ko: '', th: '', hi: '' },
    ...
    },
    {
      ...
      pages: [{
        ...
        markdown: { en: authStep, zh: '', ja: '', ko: '', th: '', hi: '' },
    ...
    },
    {
      ...
      pages: [{
        ...
        markdown: { en: voiceChannelStep, zh: '', ja: '', ko: '', th: '', hi: '' },
    ...
    },
    {
      ...
      pages: [{
        ...
        markdown: { en: settingsStep, zh: '', ja: '', ko: '', th: '', hi: '' },
    ...
    },
    {
      ...
      pages: [{
        ...
        markdown: { en: capabilitiesStep, zh: '', ja: '', ko: '', th: '', hi: '' },
    ...
    },
    {
      ...
      pages: [{
        ...
        markdown: { en: testStep, zh: '', ja: '', ko: '', th: '', hi: '' },
