    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          highlight: {
            en: '**Model availability:** If Claude models are not accessible from your region, use **GPT 5.6 Sol** instead.',
            zh: '**模型可用性：** 如果你所在的地区无法访问 Claude 模型，请改用 **GPT 5.6 Sol**。',
            ja: '**モデルの可用性:** お住まいの地域から Claude モデルにアクセスできない場合は、代わりに **GPT 5.6 Sol** を使用してください。',
            ko: '**모델 가용성:** 해당 지역에서 Claude 모델에 액세스할 수 없는 경우 **GPT 5.6 Sol**을 대신 사용하세요.',
            th: '**ความพร้อมใช้งานของโมเดล:** หากไม่สามารถเข้าถึงโมเดล Claude จากภูมิภาคของคุณได้ ให้ใช้ **GPT 5.6 Sol** แทน',
            hi: '**मॉडल उपलब्धता:** यदि आपके क्षेत्र में Claude मॉडल उपलब्ध नहीं हैं, तो इसके बजाय **GPT 5.6 Sol** का उपयोग करें।',
            vi: '**Khả năng cung cấp mô hình:** Nếu không thể truy cập các mô hình Claude từ khu vực của bạn, hãy sử dụng **GPT 5.6 Sol** thay thế.',
          },
