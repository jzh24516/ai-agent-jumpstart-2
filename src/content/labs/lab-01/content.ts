...
const browserProfileSetupText = { en: browserProfileSetup, zh: browserProfileSetup, ja: browserProfileSetup, ko: browserProfileSetup }
  ...
  steps: [
    {
      ...
      title: { en: 'Browser Profile Setup', zh: 'Browser Profile Setup', ja: 'Browser Profile Setup', ko: 'Browser Profile Setup' },
      pages: [{
        id: 'browser-profile-setup',
        paragraphs: [],
